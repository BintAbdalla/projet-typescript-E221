...
function listerRendezVous() {
    ...
    rendezVous.forEach(rv => {
        ...
        console.log(`Rendez-vous ${rv.id}: ${medecin === null || medecin === void 0 ? void 0 : medecin.prenom} ${medecin === null || medecin === void 0 ? void 0 : medecin.nom} avec ${patient === null || patient === void 0 ? void 0 : patient.prenom} ${patient === null || patient === void 0 ? void 0 : patient.nom} le ${rv.date}`);
    });
...
function listerRendezvousMedecin() {
    ...
    rendezVousPourMedecin.forEach(rv => {
        const patient = patients.find(p => p.id === rv.patientId);
        console.log(`Rendez-vous ${rv.id}: ${patient === null || patient === void 0 ? void 0 : patient.prenom} ${patient === null || patient === void 0 ? void 0 : patient.nom} le ${rv.date}`);
    });
